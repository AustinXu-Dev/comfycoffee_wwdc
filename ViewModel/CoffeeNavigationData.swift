...
struct CoffeeNavigationData {
    let mainData = [
        ...
        DataModel(text: "Daily Checkin",description: "Calculate your consumption",image: "books.vertical", viewType: .daily),
        DataModel(text: "Coffee Beans", description: "Learn more about coffee beans", image: "calendar.badge.checkmark", viewType: .coffeebeans),
    ]
